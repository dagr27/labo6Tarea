...
function programa(){
    ...
    while(opc != 0){
        ...
        if(opc === 0){
            ...
            console.log("Listado De productos, Ingrese la posicion del stock del producto a modificar o introduz ca 0 para cancelar");
            mostrar(aux);
            var n = prompt("Ingrese un numero: ");
            (n==0)? "" : modificar(n, aux);
            
        }else if(opc == 3){
            console.log("Listado De productos, Ingrese la posicion del producto a vender o introduzca 0 para cancelar");
            mostrar(aux);
            var n = prompt("Ingrese un numero: ");
